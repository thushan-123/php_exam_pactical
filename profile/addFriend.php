...
$query = "SELECT * FROM user WHERE NOT id=$user_id AND id NOT IN (SELECT friend_id FROM friends WHERE user_id=$user_id ) LIMIT $start , $page_no_recodes;";
...
<body>
    ...
    <div id="container">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action='' method='post'>
                                        ...
                                        <button type='submit' name='submit_btn'>add a friend</button>
                                    </form>
        ...
        <div id="buttons">
            <button type="button" id="button2" onclick = "navFriend()">Friend list</button>
